                  ...
                  >
                        ...
                        {gatePassEntriesState.map((eachEntry, i) => {
                          return (
                            <tr className="headings-for-Production-Form-Shif ">
                              ...
                              <td
                                className="column-title     text-left  p-0 px-1"
                                style={{
                                  width: "10%",
                                  paddingRight: "2px",
                                  paddingLeft: "2px",
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-8 px-0">
                        <div className="field item form-group">
                          <label className="col-form-label col-md-4 col-sm-4  label-align">
                            Total Sharing Weight  <span className="required">*</span>
                          </label>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4 px-0">
                        <div className="field item form-group">
                          <label className="col-form-label col-md-4 col-sm-4  label-align">
                            Dying Process  <span className="required">*</span>
                          </label>
                          <div className="col-md-8 col-sm-8 pr-3">
                            <input
                              type="text"
                      ...
                      <div className="col-md-4 px-0">
                        <div className="field item form-group">
                          <label className="col-form-label col-md-4 col-sm-4  label-align">
                            Dying Weight   <span className="required">*</span>
                          </label>
                          <div className="col-md-8 col-sm-8 pr-3">
                            <input
                              type="number"
                    ...
                    <div className="row mt-3">
                      <div className="col-md-4 px-0  ">
                        <label className="col-form-label col-md-3 col-sm-3 px-0 offset-md-1 label-align">
                          Driver_Name   <span className="required">*</span>
                        </label>
                        <div className="col-md-8 col-sm-8">
                          <input
                      ...
                      <div className="col-md-4 px-0">
                        <div className="field item form-group">
                          <label className="col-form-label col-md-4 col-sm-4  label-align">
                            Vehicle_Num:  <span className="required">*</span>
                          </label>
                          <div className="col-md-8 col-sm-8 pr-3">
                            <input
                              className="form-control form-control-sm"
