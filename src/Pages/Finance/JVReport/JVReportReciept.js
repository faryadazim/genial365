  ...
  return (
    <div>
      <div className="x_content" ref={ref}>
        <div className="row">
          <div
            className="col-md-6 text-dark px-4 "
            style={{ fontSize: "13px", fontWeight: "500" }}
          >
            <div className="col-md-5">Voucher Inv</div>
          ...
          <div
            className="col-md-4 text-dark px-4 "
            style={{ fontSize: "13px", fontWeight: "500" }}
          >
            {" "}
            Date : <strong>  
        ...
        <div className="row">
          <div
            ...
            style={{ fontSize: "13px", fontWeight: "500" }}
          >
            <div className="col-md-5"> Weaver Name :</div>
            <div className="col-md-7">
        ...
        <div className="row mx-3  reportTableHead mt-2 ">
          <div className=" col-md-8   font-size-12   right-border-1  text-center  my-1  py-1">
            Particulars
          </div>
          <div className=" col-md-4     font-size-12  text-center  my-1  right-border-2  py-1">
            Amount
          </div>
        </div>
        ...
        <>
          <div className="row mx-3  reportTableBody mb-3">
            <div className=" col-md-8  left-border-2 px-0 py-auto right-border-2  bottom-border-2   py-1  text-left px-2">
              Description:{
